...
namespace vp.functions
{
    ...
    {
        public const string PurchaseCompleteReturn = "F_PurchaseCompleteReturn";
        public const string PurchaseGet = "F_PurchaseGet";

        public const string SamplePurchase = "F_SamplePurchase";
        public const string SampleSearch = "F_SampleSearch";
