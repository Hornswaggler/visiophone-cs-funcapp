...
namespace vp.services
{
    public class StripeService : BaseEntity<StripeProfile>, IStripeService
    {
        ...
        public Price GetPrice(string priceId) {
            ...
            return service.Get(priceId);
        }

        public async Task<Product> UpsertProduct(string accountId, string productId, string name, string description, string defaultCurrency, decimal cost = 100.0m) {
